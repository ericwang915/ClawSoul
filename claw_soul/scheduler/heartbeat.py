"""
Heartbeat monitor for claw_soul.
...
Configuration (claw_soul.json or env vars)
-------------------------------------------
    ...
    def __init__(
        ...
        if log_path is None:
            try:
                ...
                log_path = os.path.join(os.path.expanduser("~/.claw_soul"), "context", "logs", "heartbeat.log")
...
def _build_file_logger(log_path: str) -> logging.Logger:
    ...
    file_logger = logging.getLogger("claw_soul.heartbeat.file")
...
def create_heartbeat(
    ...
    """Create a HeartbeatMonitor from claw_soul.json / env vars."""
