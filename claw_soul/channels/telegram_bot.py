...
Group behaviour
---------------
Set ``channels.telegram.requireMention`` to ``true`` in claw_soul.json to
...
class TelegramBot:
    ...
    async def _cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            "\U0001f44b Hi! I'm your ClawSoul agent.\n\n"
...
def create_bot(session_manager: "SessionManager") -> TelegramBot:
    """Create a TelegramBot from claw_soul.json / env vars."""
