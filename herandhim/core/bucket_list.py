...
Distinct from :class:`~herandhim.scheduler.wishlist.WishlistManager` in two
ways:
...
Storage: ``~/.herandhim/context/bucket_list.json``.
"""
...
def _path() -> str:
    return os.path.join(str(config.HERANDHIM_HOME), "context", "bucket_list.json")
