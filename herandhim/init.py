"""
Project initialiser for herandhim.
...
-----------------------
  ...
  context/profile/    — PROFILE.md background
  context/calendar/   — daily generated schedule
...
def init(project_path: str | None = None) -> None:
    ...
    print(f"Initialising HerAndHim in: {application_dir}")

    if not os.path.exists(templates_dir):
        print("Warning: templates directory not found — using minimal fallbacks.")

    for component in ("memory", "knowledge", "skills", "persona", "soul", "profile", "calendar", "tools", "files"):
