...
Reads OAuth 1.0a User Context credentials from herandhim.json
...
def _load_creds() -> dict[str, str]:
    """Read credentials from env first, then herandhim.json. Missing keys are empty."""
...
def _build_client() -> tweepy.Client:
    ...
    if missing:
        print(
            ...
            ".\nSet skills.twitter.* in herandhim.json or TWITTER_* env vars.",
            file=sys.stderr,
        )
        sys.exit(1)
