...
``herandhim/onboard.py``. Same option set, same file generators — just
...
#
# herandhim.json is the store; the three identity .md files are generated
...
def _persist_config(cfg: dict) -> None:
    """Write the config dict back to herandhim.json."""
